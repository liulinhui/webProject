...
public class LogAop_1 {
     ...
     * @param joinPoint
     */
    @Before("@annotation(com.learn.web.test.springaop.annotation.Log)")
    ...
    @After("@annotation(com.learn.web.test.springaop.annotation.Log)")
...
//    @Around("@annotation(com.learn.web.test.springaop.annotation.Log)")
