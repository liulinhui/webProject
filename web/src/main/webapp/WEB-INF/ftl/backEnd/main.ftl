...
<#assign reourcesPath="/resources/backEnd"/>
    ...
    <link href="${reourcesPath}/assets/css/main-min.css" rel="stylesheet" type="text/css"/>
</head>
<body>

<div class="header">
    <div class="dl-log">欢迎您，<span class="dl-log-user">admin</span><a href="###" title="退出系统"
...
<script type="text/javascript" src="${reourcesPath}/./assets/js/bui.js"></script>
<script type="text/javascript" src="${reourcesPath}/./assets/js/config.js"></script>
    ...
    BUI.use('common/main', function () {
        var config = [{
            ...
            menu: [{
                text: '首页内容',
                items: [
                    {id: 'code', text: '首页代码', href: 'code.html', closeable: false},
